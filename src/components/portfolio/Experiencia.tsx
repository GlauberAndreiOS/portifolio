...
export default function Experiencia() {
	return (
		<Section id="experiencia" title="Experiência">
			...
			<EmpresaItem
				empresa="Frelance"
				periodo_inicio="Dezembro 2022"
				periodo_fim="Janeiro 2023"
				cargos={[
					{
						periodo_inicio: "Dezembro 2022",
						periodo_fim: "Janeiro 2023",
						cargo: "Programador Júnior",
						descricao: "Desenvolvi um sistema de inscrições para o evento Intermed 2023, da Atlética de Medicina da UFGD, utilizando React Native (SDK 48). Nesse projeto, implementei a integração com o SDK do Mercado Pago, criando um backend em Node.js responsável por intermediar a comunicação e validar o status dos pagamentos. Além disso, atendi à demanda do cliente de registrar os inscritos em uma planilha no Google Sheets. Para isso, configurei uma integração com o Firebase, garantindo que os dados fossem atualizados automaticamente sempre que a planilha fosse acessada, o que trouxe maior confiabilidade e consistência às informações exibidas."
					}
				]}
			/>
			<EmpresaItem
